...
import 'package:firebase_task_auth/view/SignUpPage.dart';
      ...
      children: <Widget>[
        Container(
          ...
          child: RaisedButton(
            ...
            onPressed: () async{
              var res = Auth().logIn(_email.text, _password.text);
              if (res != null){
                print(res);
                Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (BuildContext context) => Tasks()));
              }
            },
            child: Text(
              "Login",
